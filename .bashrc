...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/kellen/.miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/kellen/.miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/kellen/.miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
